...
export async function POST(req: Request) {
  ...
  const system =
    ...
    "Правила щодо полів:\n" +
    "- title: коротке зрозуміле формулювання УКРАЇНСЬКОЮ мовою — навіть якщо користувач " +
    "написав іншою мовою (російською, англійською тощо), задачу все одно формулюй українською; " +
